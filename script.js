document.addEventListener('DOMContentLoaded', () => {
  ...
  measurementId: "G-TZ8Z1GS8CN"
    ...
    async function handleSendMessage() {
        ...
        // Save chat to Firestore (separate try-catch so it doesn't trigger "Connection Error")
        if (result) {
            try {
                ...
                // Fallback: save to localStorage so history still works
                saveToLocalHistory(user.uid, statement, result);
            }
        }
    }
